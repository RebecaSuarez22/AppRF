...
function añadirAlumnos ({route, navigation}) {
    ...
    const items = [ {name: "", img: require("../assets/alumnos/a1.png")}, 
                    {name: "", img: require("../assets/alumnos/a2.png")}, 
                    {name: "", img: require("../assets/alumnos/a3.png")}, 
                    {name: "", img: require("../assets/alumnos/a4.png")}, 
                    {name: "", img: require("../assets/alumnos/a5.png")}, 
                    {name: "", img: require("../assets/alumnos/a6.png")}, 
                    {name: "", img: require("../assets/alumnos/a7.png")}, 
                    {name: "", img: require("../assets/alumnos/a8.png")}, 
                    {name: "", img: require("../assets/alumnos/a9.png")}];
